...
_G.packer_plugins = {
  ...
  ["virt-column.nvim"] = {
    loaded = true,
    path = "/home/mashu/.local/share/nvim/site/pack/packer/start/virt-column.nvim",
...
vim.cmd [[au VimEnter * ++once lua require("packer.load")({'hop.nvim', 'nvim-autopairs', 'which-key.nvim'}, { event = "VimEnter *" }, _G.packer_plugins)]]
