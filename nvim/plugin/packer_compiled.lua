...
_G.packer_plugins = {
  ...
  catppucin = {
    ...
    loaded = true,
    path = "/home/mashu/.local/share/nvim/site/pack/packer/start/catppucin",
  ...
  ["friendly-snippets"] = {
    loaded = true,
    path = "/home/mashu/.local/share/nvim/site/pack/packer/start/friendly-snippets",
  ...
  ["nvim-cmp"] = {
    after = { "cmp-cmdline", "cmp-path", "cmp_luasnip" },
  ...
  ["nvim-tree.lua"] = {
    ...
    loaded = true,
    path = "/home/mashu/.local/share/nvim/site/pack/packer/start/nvim-tree.lua",
...
vim.cmd [[au VimEnter * ++once lua require("packer.load")({'nvim-autopairs', 'hop.nvim'}, { event = "VimEnter *" }, _G.packer_plugins)]]
